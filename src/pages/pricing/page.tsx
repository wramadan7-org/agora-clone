...
export default function Page() {
  ...
  return (
    <main className="flex flex-col gap-10 pb-10 pt-24 max-w-[1400px] mx-auto">
            ...
            {supportedNetworks.map(
              (item: { name: string; image: string }, index: number) => (
                <img
                  ...
                  src={item?.image}
                  alt={item?.name}
                  className="w-5 sm:w-7 object-center object-contain"
                />
              )
            )}
          </div>
      ...
      <section id="billing" className="px-5 w-full items-center justify-center">
      ...
      <section id="commpare-plans" className="flex items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center gap-6">
          ...
          <div className="bg-red-50 p-5 rounded-md flex flex-col gap-3 w-full items-center justify-center mt-8">
            <p className="font-bold text-neutral-900 text-center text-base md:text-3xl max-w-[726px]">
              ...
              multiple pages and accounts for our company and to see them all in
              one place is a dream. It's also great to see when another team
              member is online so we don't overlap and are more efficient."
            </p>
