  ...
  return (
    <div className=" h-dvh">
      ...
      >
        <nav
          id="navbar"
          className="flex flex-row justify-between items-center px-5 relative"
        >
          ...
          <button
            ...
            className="outline-none border-none w-fit cursor-pointer"
          ...
          {isOpenMenuState && (
            <div className="absolute top-10 border-t border-gray-200 shadow-2xl left-0 flex flex-col w-full bg-white px-5 pt-7 pb-10 gap-3 rounded-b-md">
